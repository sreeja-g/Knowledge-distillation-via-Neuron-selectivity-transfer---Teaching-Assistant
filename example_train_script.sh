...
CUDA_VISIBLE_DEVICES=0 python -u train_base.py \
                           ...
                           --net_name resnet152 \
                           --note base-c10-r152 \
                           --trained_net "./results/base/base-c10-r152/model_best.pth.tar" \
...
#                            --t_model "./results/base/base-c10-r152/model_best.pth.tar" \
#                            --s_init "./results/base/base-c10-r18/initial_r18.pth.tar" \
#                            --data_name chest_xray \
#                            --num_class 3 \
#                            --t_name resnet152 \
#                            --s_name resnet18 \
#                            --kd_mode nst \
#                            --lambda_kd 3.0 \
#                            --note nst-c3-r152-r18-kd3

# NST TA
CUDA_VISIBLE_DEVICES=0 python -u train_kd.py \
                           --save_root "./results/nst/" \
                           --t_model "./results/base/base-c10-r152/model_best.pth.tar" \
                           --s_init "./results/base/base-c10-r101/initial_r101.pth.tar" \
                           --data_name chest_xray \
                           --num_class 3 \
                           --t_name resnet152 \
                           --s_name resnet101 \
